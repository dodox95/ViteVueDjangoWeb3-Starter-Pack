...
<nav class="bg-white border-gray-200 px-2 md:px-4 py-2.5 dark:bg-gray-900">
    ...
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        <a href="https://flowbite.com" class="flex items-center">
            <img src="../assets/eth.png" class="mr-3 h-6 sm:h-9" alt="Ethereum Logo" />

            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ethereum</span>
        </a>
...
import WalletModal from '@/components/WalletModal.vue';
  ...
  export default {
    ...
    methods: {
      // Any additional methods related to the WalletModal or Navbar
    }
  }
  </script>
